...
jQuery(function ($) {
    ...
    var bgimages = "url('images/object1263556025.png'),url('images/object892522067.png'),url('images/object2089788083.png'), ".split(",");
    var bgpositions = "310px 88px,312px 35px,-18px -1px, ".split(",");
